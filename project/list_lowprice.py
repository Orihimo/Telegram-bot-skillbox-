...
def get_list_hotels_lowprice(id_city: str, city_count: int, check_in_date: dict, check_out_date: dict, ) -> list:
    """
...
#print(get_list_hotels_lowprice(id_city = '1639', city_count = 2, check_in_date = {'day': 23, 'month': 6, 'year': 2023}, check_out_date = {'day': 28, 'month': 6, 'year': 2023}))